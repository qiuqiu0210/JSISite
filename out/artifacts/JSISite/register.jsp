            ...
            <div class="col-sm-5">
                <div class="basic-login">
                    ...
                    <form action="register" role="form">
                        ...
                        <div class="form-group">
                            <label for="repassword"><i class="icon-lock"></i> <b>Re-enter Password</b></label>
                            <input class="form-control"  id="repassword" name="repassword" type="password" placeholder="">
                        </div>
                        <div class="form-group">
