...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew">
    ...
    <form action="modifyNews" method="post">
        ...
        <input type="hidden" name="news.newsTime" value="${news.newsTime}"/>
        ...
        <tr align="center">
            ...
            <td align="left" bgcolor="#FFFFFF"> <textarea name="news.newsContent" cols="50" rows="8">${news.newsContent}</textarea> </td>
        </tr>
        <tr align="center">
