...
<table width="100%" height="78"  border="0" align="center" cellpadding="-2" cellspacing="-2">
      ...
      <tr>
        ...
        <td height="13" colspan="3" align="center">联系方式：MSN:admin@jsi.buaa.edu.cn</td>
        <td width="141">&nbsp;</td>
      </tr>
      <tr>
        <td height="15" colspan="2">&nbsp;</td>
        <td width="464" valign="bottom" align="center"> CopyRight &copy; 2014 jsi.buaa.edu.cn 中德联合软件技术研究所</td>
        <td colspan="2">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
