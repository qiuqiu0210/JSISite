...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableNew"> 
  ...
  <form action="addNews" method="post" enctype="multipart/form-data">
    <tr align="center"> 
      ...
      <td width="83%" height="27" align="left" bgcolor="#FFFFFF"> <input name="news.newsTitle" type="text" size="50"> </td>
    </tr> 
    <tr align="center"> 
      <td height="27" bgcolor="#FFFFFF">所属软件类别：</td> 
      <td height="27" align="left" bgcolor="#FFFFFF"><select name="sid" onChange="su()"> <option>―无―</option>
          <%--<%--%>
...
<%--}%> --%>
    ...
    <tr align="center"> 
      ...
      <td height="27" align="left" bgcolor="#FFFFFF"><select name="sfid"> <option>―无―</option>
          <%--<%--%>
...
<%--}%> --%>
    ...
    <tr align="center"> 
      ...
      <input name="upload" type="file" size="50"></td>
    </tr> 
    <tr align="center"> 
